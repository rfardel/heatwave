...
df_lat_lon = pd.read_csv(
    os.path.join(APP_PATH, os.path.join("../scratch/front-end old/data",
                                        "../scratch/front-end old/lat_lon_counties.csv"))
)
df_lat_lon["FIPS "] = df_lat_lon["FIPS "].apply(lambda x: str(x).zfill(5))

df_full_data = pd.read_csv(
    os.path.join(
        APP_PATH, os.path.join("../scratch/front-end old/data", "age_adjusted_death_rate_no_quotes.csv")
    )
)
